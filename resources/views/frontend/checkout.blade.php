        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <button type="submit" class="btn btn-success w-100 float-end cod_btn">Place Order | COD</button> <br>
                    <button type="submit" class="btn btn-primary w-100 mt-3 esewa_btn">Pay With eSewa</button>
...
@section('scripts')
     <script src="https://www.paypal.com/sdk/js?client-id=Aec1KK4luf5cNreYsrMwhPAHpieDDdNBcse0mwON7xRgSA5Jsd1vhhxcU1A16mzBTKWurM8LhTO5Oc-h"></script>
     <script>
    paypal.Buttons({
